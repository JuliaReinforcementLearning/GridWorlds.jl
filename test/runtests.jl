...
ENVS = [EmptyGridWorld, GridRooms, SequentialRooms, GoToDoor, DoorKey, CollectGems, DynamicObstacles]

MAX_STEPS = 3000
NUM_RESETS = 3

get_terminal_rewards(env::Union{EmptyGridWorld, GridRooms, SequentialRooms, DoorKey}) = (env.goal_reward,)
