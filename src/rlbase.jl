...
GW.get_action_names(env::RLBaseEnv{E}) where {E <: GW.AbstractGridWorldGame} = GW.get_action_names(env.env)
...
RLBase.StateStyle(env::RLBaseEnv{E}) where {E <: GW.SokobanUndirectedModule.SokobanUndirected} = RLBase.InternalState{Any}()
RLBase.state_space(env::RLBaseEnv{E}, ::RLBase.InternalState) where {E <: GW.SokobanUndirectedModule.SokobanUndirected} = nothing
RLBase.state(env::RLBaseEnv{E}, ::RLBase.InternalState) where {E <: GW.SokobanUndirectedModule.SokobanUndirected} = env.env.tile_map

RLBase.reset!(env::RLBaseEnv{E}) where {E <: GW.SokobanUndirectedModule.SokobanUndirected} = GW.reset!(env.env)

RLBase.action_space(env::RLBaseEnv{E}) where {E <: GW.SokobanUndirectedModule.SokobanUndirected} = 1:GW.SokobanUndirectedModule.NUM_ACTIONS
(env::RLBaseEnv{E})(action) where {E <: GW.SokobanUndirectedModule.SokobanUndirected} = GW.act!(env.env, action)
...
RLBase.StateStyle(env::RLBaseEnv{E}) where {E <: GW.TransportDirectedModule.TransportDirected} = RLBase.InternalState{Any}()
RLBase.state_space(env::RLBaseEnv{E}, ::RLBase.InternalState) where {E <: GW.TransportDirectedModule.TransportDirected} = nothing
RLBase.state(env::RLBaseEnv{E}, ::RLBase.InternalState) where {E <: GW.TransportDirectedModule.TransportDirected} = (env.env.env.tile_map, env.env.agent_direction)

RLBase.reset!(env::RLBaseEnv{E}) where {E <: GW.TransportDirectedModule.TransportDirected} = GW.reset!(env.env)

RLBase.action_space(env::RLBaseEnv{E}) where {E <: GW.TransportDirectedModule.TransportDirected} = 1:GW.TransportDirectedModule.NUM_ACTIONS
(env::RLBaseEnv{E})(action) where {E <: GW.TransportDirectedModule.TransportDirected} = GW.act!(env.env, action)
